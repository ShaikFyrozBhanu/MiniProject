...
resource "aws_instance" "Project" {
  ...
  user_data              = <<-EOF
              ...
              unzip awscliv2.zip
              sudo ./aws/install
              aws ecr-public get-login-password --region us-east-1 | docker login --username AWS --password-stdin public.ecr.aws/e6v4n7j9
              sudo docker pull public.ecr.aws/e6v4n7j9/ecr:latest
              sudo docker run -d -p 8080:80 public.ecr.aws/e6v4n7j9/ecr:latest
  EOF
